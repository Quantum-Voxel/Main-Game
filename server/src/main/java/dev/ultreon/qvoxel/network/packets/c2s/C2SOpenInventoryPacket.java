...
public record C2SOpenInventoryPacket() implements Packet<InGameServerPacketHandler> {
    public static final PacketId<C2SOpenInventoryPacket> ID = new PacketId<>("serverbound/block_break", C2SOpenInventoryPacket.class);
    public static final PacketCodec<C2SOpenInventoryPacket> CODEC = PacketCodec.unit(C2SOpenInventoryPacket::new);
}
