...
public final class BlockStateDefinition {
    ...
    public static class Builder {
        private final List<StatePropertyKey<?>> keys = new ArrayList<>();
        ...
        public void add(List<StatePropertyKey<?>> keys) {
            this.keys.addAll(keys);
        }

        public BlockStateDefinition build() {
            return new BlockStateDefinition(List.copyOf(keys), block);
        }
    }
}