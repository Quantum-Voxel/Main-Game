...
public final class Moon extends CelestialBody {
    public Moon() {
        super(CommonConstants.id("moon"));
    }
    ...
    public void render(ShaderProgram program, Mesh mesh) {
        ...
        float rotation = world.getTimeOfDay() * 360f / (float) ClientWorld.DAY_TIME;
        modelMatrix.identity();
        modelMatrix.rotateX(Math.toRadians(rotation + 180));
